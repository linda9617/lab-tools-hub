...
(function(){
  ...
  if (srcBack && heroInner && !heroInner.querySelector('.hero-back')){
    ...
    back.innerHTML = '<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="10,3 4,8 10,13"/></svg><span>Hub</span>';
